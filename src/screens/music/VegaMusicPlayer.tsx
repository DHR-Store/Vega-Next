...
export const VegaMusicPlayerScreen = () => {
  ...
  const song = {
    ...
    album: 'Jawan',
    image: 'https://placehold.co/500x500/333/FFF?text=Mr.+%26+Mrs.+Mahi',
    duration: 283, // 4 minutes 43 seconds
  };
  ...
  useEffect(() => {
    ...
    if (isPlaying) {
      interval = setInterval(() => {
        setCurrentProgress((prev) => (prev < song.duration ? prev + 1 : prev));
      }, 1000);
    } else {
    ...
    <View style={styles.playerContainer}>
      ...
      <View style={styles.topControls}>
        ...
        <View style={styles.albumInfo}>
          <Text style={styles.playingFromText}>PLAYING FROM ALBUM</Text>
          <Text style={styles.albumTitleText}>{song.album}</Text>
        </View>
      ...
      <View style={styles.bottomSection}>
        ...
        <View style={styles.progressBarContainer}>
          <View style={styles.progressBarBackground}>
            <View style={[styles.progressBar, { width: `${(currentProgress / song.duration) * 100}%`, backgroundColor: primary }]} />
          </View>
          <View style={styles.timeStamps}>
            <Text style={styles.timeStampText}>{formatTime(currentProgress)}</Text>
            <Text style={styles.timeStampText}>{formatTime(song.duration)}</Text>
          </View>
        </View>
        ...
        <View style={styles.playbackControls}>
          ...
          <TouchableOpacity onPress={handlePlayPause} style={[styles.playButton, { backgroundColor: primary }]}>
